...
class RegressPhenotypes(protected val args: RegressPhenotypesArgs) extends BDGSparkCommand[RegressPhenotypesArgs] {
  ...
  def loadGenotypes(sc: SparkContext): Dataset[GenotypeState] = {
    ...
    val genoStatesWithNames = genotypeStates.select(concat($"contigName", lit("_"), $"end", lit("_"), $"alt") as "contigName",
      ...
      genotypeStates("ancestralAllele"),
      genotypeStates("alleleCount"),
      genotypeStates("readDepth"),
      genotypeStates("forwardReadDepth"),
      genotypeStates("reverseReadDepth"),
      genotypeStates("referenceReadDepth"),
      genotypeStates("referenceForwardReadDepth"),
      genotypeStates("referenceReverseReadDepth"),
      genotypeStates("alleleFrequency"),
      genotypeStates("cigar"),
      genotypeStates("dbSnp"),
      genotypeStates("hapMap2"),
      genotypeStates("hapMap3"),
      genotypeStates("validated"),
      genotypeStates("thousandGenomes"),
      genotypeStates("somatic"),
      genotypeStates("transcriptEffectsAlternateAllele"),
      genotypeStates("transcriptEffectsEffects"),
      genotypeStates("transcriptEffectsGeneName"),
      genotypeStates("transcriptEffectsGeneId"),
      genotypeStates("transcriptEffectsFeatureType"),
      genotypeStates("transcriptEffectsFeatureId"),
      genotypeStates("transcriptEffectsBiotype"),
      genotypeStates("transcriptEffectsRank"),
      genotypeStates("transcriptEffectsTotal"),
      genotypeStates("transcriptEffectsGenomicHgvs"),
      genotypeStates("transcriptEffectsTranscriptHgvs"),
      genotypeStates("transcriptEffectsProteinHgvs"),
      genotypeStates("transcriptEffectsCdnaPosition"),
      genotypeStates("transcriptEffectsCdnaLength"),
      genotypeStates("transcriptEffectsCdsPosition"),
      genotypeStates("transcriptEffectsCdsLength"),
      genotypeStates("transcriptEffectsProteinPosition"),
      genotypeStates("transcriptEffectsProteinLength"),
      genotypeStates("transcriptEffectsDistance"),
      genotypeStates("transcriptEffectsMessages"),
      // genotypeStates("attr"),
