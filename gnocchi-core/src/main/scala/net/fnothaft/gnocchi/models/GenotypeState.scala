...
case class GenotypeState(contigName: String,
                         ...
                         transcriptEffectsAlternateAllele: Option[Array[String]],
                         transcriptEffectsEffects: Option[Array[Array[String]]],
                         transcriptEffectsGeneName: Option[Array[String]],
                         transcriptEffectsGeneId: Option[Array[String]],
                         transcriptEffectsFeatureType: Option[Array[String]],
                         transcriptEffectsFeatureId: Option[Array[String]],
                         transcriptEffectsBiotype: Option[Array[String]],
                         transcriptEffectsRank: Option[Array[Integer]],
                         transcriptEffectsTotal: Option[Array[Integer]],
                         transcriptEffectsGenomicHgvs: Option[Array[String]],
                         transcriptEffectsTranscriptHgvs: Option[Array[String]],
                         transcriptEffectsProteinHgvs: Option[Array[String]],
                         transcriptEffectsCdnaPosition: Option[Array[Integer]],
                         transcriptEffectsCdnaLength: Option[Array[Integer]],
                         transcriptEffectsCdsPosition: Option[Array[Integer]],
                         transcriptEffectsCdsLength: Option[Array[Integer]],
                         transcriptEffectsProteinPosition: Option[Array[Integer]],
                         transcriptEffectsProteinLength: Option[Array[Integer]],
                         transcriptEffectsDistance: Option[Array[Integer]],
                         transcriptEffectsMessages: Option[Array[String]],
                         // attr: Option[Map[String, Any]],
